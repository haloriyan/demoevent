...
class Expiring extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ...
            ->line('Kami dari panitia Pertemuan Ilmiah Tahunan Perkumpulan Subspesialis Radiologi Muskuloskeletal Indonesia (PIT PERAMI) ingin menyampaikan terima kasih atas pendaftaran Anda.')
            ->line('')
            ...
            ->line('Kami memahami bahwa hal ini mungkin menimbulkan ketidaknyamanan. Jika Anda masih berminat untuk mengikuti PIT PERAMI, Anda dapat melakukan pendaftaran ulang.')
            ->action('Ulangi Pendaftaran', url('/'))
            ->line('Kami sangat menghargai minat Anda untuk berpartisipasi dalam acara ini dan berharap Anda dapat bergabung bersama kami di PIT PERAMI mendatang.')
