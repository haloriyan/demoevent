...
<div class="fixed mobile:overflow-y-auto top-10 mobile:top-0 left-10 mobile:left-0 right-10 mobile:right-0 bottom-10 mobile:bottom-0 flex mobile:flex-col bg-white rounded-xl mobile:rounded-none">
    <div class="flex flex-col w-5/12 mobile:w-full mobile:min-h-[500px] bg-[url(/images/doodle.png)] bg-[length:auto_100%] relative rounded-s-xl mobile:rounded-s-none">
        <div class="absolute top-0 left-0 right-0 bottom-0 bg-black/20 text-white flex flex-col gap-2 mobile:gap-4 justify-end p-10 rounded-s-xl mobile:rounded-s-none">
