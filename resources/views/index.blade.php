...
<section class="p-14 bg-white mobile:p-8 px-20 mobile:px-8 flex gap-8 mobile:gap-8">
    <div class="flex flex-col items-center gap-4 grow">
        <div class="text-xs text-slate-500 text-center">Diselenggarakan oleh</div>
        <div class="flex items-center">
            <img src="/images/penyelenggara.png" alt="Sponsor" class="h-56 mobile:h-auto mobile:w-full">
        </div>
    </div>
    <div class="flex flex-col gap-4 grow">
        <div class="text-xs text-slate-500">Berkolaborasi dengan</div>
        <div class="flex items-center">
            <img src="/images/kolaborator.png" alt="Sponsor" class="h-56 mobile:h-auto">
        </div>
    </div>
</section>
