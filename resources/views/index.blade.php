...
<section class="p-20 flex gap-10" id="about">
    <img src="/images/doctors.jpg" alt="dokter" class="w-5/12 rounded-lg object-cover" style="border-top-right-radius: 80px;border-bottom-left-radius: 80px;">
    <div class="flex flex-col gap-4 grow">
        ...
        <div class="text-slate-600 leading-8 mt-4">
...
<section id="spakers" class="bg-primary p-20 flex flex-col gap-8">
    ...
    <div class="grid grid-cols-4 gap-8">
        @foreach ($speakers as $speaker)
            <div class="bg-white p-10 rounded-xl flex flex-col gap-2 CustomRadius">
...
<section id="programs" class="p-20 flex flex-col gap-8 items-center">
...
<section class="p-20 mobile:p-4">
    <div class="rounded-xl text-white bg-gradient-to-br from-blue-900 to-blue-500 w-full flex flex-col gap-8 p-20">
        <div class="flex items-center gap-8">
            <div class="flex flex-col gap-4 grow">
                <h3 class="text-4xl font-bold">Tulis Karya Ilmiah dan Buat Poster</h3>
                <div class="font-medium">Ikuti kompetisi karya tulis ilmiah dalam topik Kesehatan dan buat poster kampanye</div>
            </div>
            <a href="#" class="bg-orange-500 text-white rounded-full p-3 px-8 font-medium text-sm">
                SUBMIT ABSTRAK
            </a>
        </div>
        ...
        <div class="overflow-x-scroll flex mt-4">
            <div class="flex flex-col gap-2 basis-32 grow">
                ...
                <h4 class="mt-4">Pengiriman Abstrak</h4>
            ...
            <div class="flex flex-col gap-2 basis-32 grow">
                ...
                <h4 class="mt-4">Pengumuman Penerimaan Abstrak</h4>
            ...
            <div class="flex flex-col gap-2 basis-32 grow">
                ...
                <h4 class="mt-4">Pengiriman E-Poster</h4>
                <div class="text-xs">15 Agustus 2026</div>
            </div>
            <div class="flex flex-col gap-2 basis-32 grow">
                <div class="flex items-center">
                ...
                <h4 class="mt-4">Pengumuman Pemenang</h4>
