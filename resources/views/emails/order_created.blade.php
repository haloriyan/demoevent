...
<p>
    Kemudian mohon lakukan pembayaran melalui link berikut :
</p>
<div style="text-align: center;padding: 10px;">
    <a href="{{ route('pembayaran.instan', $trx->id) }}" style="background: #B84F26;color: #fff;padding: 15px 25px;border-radius: 8px;text-decoration: none;">
        Bayar Sekarang
    </a>
</div>
